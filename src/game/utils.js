import { DEFAULT_START_SUIT, DEFAULT_TURN_DURATION, STARTING_CARD_MAP, CARD_LIMIT, DECK_HANDS, DECK_SUITS, INVALID_CARDS, TRUMP_CARD_PREFIX, DEFAULT_GAME_MODE, MODEL_TYPE_DEFAULT } from '../utils/constants';
