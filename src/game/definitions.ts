...
const definitions = {
  ...
  E10: 'An attacker can alter information in a data store because it has weak ACLs or includes a group which is equivalent to everyone ("all Live ID holders")',
  ...
  C10: 'An attacker can get arbitrary data into logs from unauthenticated (or weakly authenticated) outsiders',
  ...
  A3: 'An attacker can make a client unavailable or unusable but the problem goes away when the attacker stops',
  A4: 'An attacker can make a server unavailable or unusable but the problem goes away when the attacker stops',
  A5: 'An attacker can make a client unavailable or unusable without ever authenticating but the problem goes away when the attacker stops',
  A6: 'An attacker can make a server unavailable or unusable without ever authenticating but the problem goes away when the attacker stops',
  A7: 'An attacker can make a client unavailable or unusable and the problem persists after the attacker goes away',
  A8: 'An attacker can make a server unavailable or unusable and the problem persists after the attacker goes away',
  A9: 'An attacker can make a client unavailable or unusable without ever authenticating and the problem persists after the attacker goes away',
  A10: 'An attacker can make a server unavailable or unusable without ever authenticating and the problem persists after the attacker goes away',
  AJ: 'An attacker can cause the logging subsystem to stop working',
  AQ: 'An attacker can amplify a Denial of Service attack through this component with amplification on the order of 10: 1',
  AK: 'An attacker can amplify a Denial of Service attack through this component with amplification on the order of 100: 1',
  ...
  T6: "An attacker could take advantage of .NET permissions you ask for, but don't use",
