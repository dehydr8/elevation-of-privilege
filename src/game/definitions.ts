...
const definitions = {
  ...
  A3: 'An attacker can drain our easily replacable battery (battery, temporary).',
  A4: "An attacker can drain a battery that's hard to replace (sealed in a phone, an implanted medical device, or in a hard to reach location) (battery, persist).",
  A5: 'An attacker can spend our cloud budget (budget, persist).',
