...
import { createGame, downloadThreatDragonModel, downloadThreatsMarkdownFile, getImage, getModel, getPlayerNames } from './endpoints';
...
const runPublicApi = gameServer => {
  ...
  router.get('/:matchID/download/text', downloadThreatsMarkdownFile(gameServer));
